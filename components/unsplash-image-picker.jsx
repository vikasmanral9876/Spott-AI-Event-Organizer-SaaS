...
export function UnsplashImagePicker({ isOpen, onClose, onSelect }) {
  ...
  const searchImges = async (searchQuery) => {
    setLoading(true);
    try {
            ...
            <div className="grid grid-cols-3 gap-4 py-4">
              {images.map((image) => (
                <button
                  ...
                  className="relative aspect-video rounded-lg overflow-hidden border-2 border-transparent hover:border-purple-500 transition-all"
                >
                  <Image
